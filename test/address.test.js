...
import { createTestUser, removeAllTestContacts, removeTestUser, removeAllTestAddresses ,createTestContact , getTestContact, createManyTestContact, createTestAddress, getTestAddress } from "./test-util.js"
...
describe('PUT /api/contacts/:contactId/addresses/:addressId', function () {
    ...
    it('should reject if request address id not found', async () => {
        const testContact = await getTestContact()
        const testAddress = await getTestAddress()
    ...
    it('should reject if request contact id not found', async () => {
        const testContact = await getTestContact()
        const testAddress = await getTestAddress()
...
describe('DELETE /api/contacts/:contactId/addresses/:addressId', function () {
    ...
    it('should reject if address is not found delete', async () => {
        const testContact = await getTestContact()
        let testAddress = await getTestAddress()
    ...
    it('should reject if contact is not found delete', async () => {
        const testContact = await getTestContact()
        let testAddress = await getTestAddress()
...
describe('GET /api/contacts/:contactId/addresses', function () {
    ...
    it('should reject if contact is not found list', async () => {
        const testContact = await getTestContact()
